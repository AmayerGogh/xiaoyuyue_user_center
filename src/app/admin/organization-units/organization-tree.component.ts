...
export class OrganizationTreeComponent extends AppComponentBase implements AfterViewInit {
    ...
    ngAfterViewInit(): void {
        ...
        this.getTreeDataFromServer(treeData => {
            ...
            if (this.isGranted("ManageOrganizationTree")) {
            ...
            this._$tree
                ...
                .on('move_node.jstree', (e, data) => {
                    ...
                    if (!this.isGranted(this.adminPermissions.userManage_OrganizationUnits_ManageOrganizationTree)) {
    ...
    private contextMenu(node: any, self: OrganizationTreeComponent) {
        let canManageOrganizationTree = self.isGranted(this.adminPermissions.userManage_OrganizationUnits_ManageOrganizationTree);
