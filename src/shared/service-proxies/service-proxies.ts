...
export class OrgBookingOrderServiceProxy {
     ...
     * @return Success
     */
    getOrders(bookingName: string, customerName: string, bookingDate: Moment, startMinute: number, endMinute: number, phoneNumber: string, gender: Gender, creationDate: Moment, status: Status[], sorting: string, maxResultCount: number, skipCount: number): Observable<PagedResultDtoOfBookingOrderListDto> {
     ...
     * @return Success
     */
    getOrders2Booking(bookingId: number, customerName: string, bookingDate: Moment, startMinute: number, endMinute: number, phoneNumber: string, gender: Gender2, creationDate: Moment, status: Status2[], sorting: string, maxResultCount: number, skipCount: number): Observable<BookingsOrderListDto> {
    ...
    batchComfirmBookingOrder(input: BatchComfirmInput): Observable<void> {
        ...
        return this.http.request(url_, options_).flatMap((response_) => {
            return this.processBatchComfirmBookingOrder(response_);
        }).catch((response_: any) => {
            if (response_ instanceof Response) {
                try {
                    return this.processBatchComfirmBookingOrder(response_);
    ...
    protected processBatchComfirmBookingOrder(response: Response): Observable<void> {
        const status = response.status; 
    ...
    comfirmBookingOrder(input: EntityDtoOfInt64): Observable<void> {
        ...
        return this.http.request(url_, options_).flatMap((response_) => {
            return this.processComfirmBookingOrder(response_);
        }).catch((response_: any) => {
            if (response_ instanceof Response) {
                try {
                    return this.processComfirmBookingOrder(response_);
    ...
    protected processComfirmBookingOrder(response: Response): Observable<void> {
        const status = response.status; 
...
export class BatchComfirmInput implements IBatchComfirmInput {
    ...
    constructor(data?: IBatchComfirmInput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): BatchComfirmInput {
        let result = new BatchComfirmInput();
        result.init(data);
        return result;
    }
...
export interface IBatchComfirmInput {
    /** 预约订单id数组 */
    ids: number[];
}
