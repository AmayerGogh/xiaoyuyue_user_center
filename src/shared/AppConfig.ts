...
//     public static readonly AppBaseUrl = 'http://www.xiaoyuyue.com';
...
export class AppConfig {
    public static readonly RemoteServiceBaseUrl = 'http://vappshk.oicp.net:9090';
    public static readonly AppBaseUrl = 'http://localhost:5201';
    public static readonly UserCenterUrl = 'hhttp://localhost:5201';
